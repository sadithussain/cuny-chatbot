...
URL = "https://www.lehman.edu/ctl/For-Students/student-resources/?utm_source=chatgpt.com"
OUTPUT_DIR = "data_demo/lehman/student_resources"
OUTPUT_CSV = os.path.join(OUTPUT_DIR, "lehman_student_resources.csv")
OUTPUT_TXT = os.path.join(OUTPUT_DIR, "lehman_student_resources.txt")
...
# Common wrappers (same pattern as your other scrapers)
