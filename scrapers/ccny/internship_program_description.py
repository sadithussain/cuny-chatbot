...
TARGET_URL = "https://www.ccny.cuny.edu/cpdi/internship-program-description"
OUTPUT_DIR = "data_demo/ccny/student_tips"
OUTPUT_FILENAME = os.path.join(OUTPUT_DIR, "internship_program_description.csv")

HEADERS = {
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36'
}

def scrape_internship_program_description():
...
if __name__ == "__main__":
    scrape_internship_program_description()