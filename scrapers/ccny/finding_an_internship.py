...
TARGET_URL = "https://www.ccny.cuny.edu/cpdi/finding-an-internship"
OUTPUT_DIR = "data_demo/ccny/student_tips"
OUTPUT_FILENAME = os.path.join(OUTPUT_DIR, "finding_an_internship.csv")

HEADERS = {
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36'
}

def scrape_finding_an_internship():
    ...
    try:
        ...
        for h in all_headings:
            if h.find('a') or "USE THE LINKS BELOW" in h.get_text():
                continue
            headings.append(h)
