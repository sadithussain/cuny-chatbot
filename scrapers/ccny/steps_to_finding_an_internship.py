...
TARGET_URL = "https://www.ccny.cuny.edu/cpdi/steps-to-finding-an-internship"
OUTPUT_DIR = "data_demo/ccny/student_tips"
OUTPUT_FILENAME = os.path.join(OUTPUT_DIR, "steps_to_finding_an_internship.csv")

HEADERS = {
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36'
}

def scrape_steps_to_finding_an_internship():
    ...
    try:
        ...
        for h in all_headings:
            if "CPDI INTERNSHIP PROGRAM" in h.get_text():
                continue;
            headings.append(h)
...
if __name__ == "__main__":
    scrape_steps_to_finding_an_internship()