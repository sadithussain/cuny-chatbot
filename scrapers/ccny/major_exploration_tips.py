...
def scrape_major_exploration_tips():
    ...
    try:
        ...
        headings = content_area.find_all('h4')
        ...
        for heading_tag in headings:
            ...
            for sibling in heading_tag.find_next_siblings():
                ...
                if sibling.name == 'p':
                    paragraphs_text.append(sibling.get_text(strip = True))
        ...
        print(f"Saving {len(scraped_data)} sections to {OUTPUT_FILENAME}...")
